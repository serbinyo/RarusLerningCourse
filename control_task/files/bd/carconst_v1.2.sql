...
CREATE TABLE IF NOT EXISTS `carconst`.`complectation_color` (
  `id` INT NOT NULL,
  `complectation_bodytype_id` INT NOT NULL,
  `color_id` INT NOT NULL,
  `img` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_complectation_color_color1_idx` (`color_id` ASC),
  INDEX `fk_complectation_color_complectation_bodytype1_idx` (`complectation_bodytype_id` ASC),
  CONSTRAINT `fk_complectation_color_color1`
    FOREIGN KEY (`color_id`)
    REFERENCES `carconst`.`color` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_complectation_color_complectation_bodytype1`
    FOREIGN KEY (`complectation_bodytype_id`)
    REFERENCES `carconst`.`complectation_bodytype` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
